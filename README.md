...
Executing the command `shotup` without parameters will launch a running
...
On Windows, `shotup.exe` will behave as expected for all supported command-line arguments, 
