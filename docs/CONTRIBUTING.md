...
See [translation instructions](https://github.com/shotup-org/translation-instruction).
...
2. [Open an issue](https://github.com/shotup-org/shotup/issues/new) and describe the issue you are having - you could include:
     - Screenshots
...
The best way to fund Shotup is to create a bounty here: https://rysolv.com/issues
